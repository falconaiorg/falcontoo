//    useEffect(() => {
//      // Function to trigger the download of the markdown text
...
export const testMarkdown = `When you know or suspect that a certain piece of data will be needed, you can use prefetching to populate the cache with that data ahead of time, leading to a faster experience.
...
If you want to prefetch together with Suspense, you will have to do things a bit differently. You can't use useSuspenseQueries to prefetch, since the prefetch would block the component from rendering. You also can not use useQuery for the prefetch, because that wouldn't start the prefetch until after suspenseful query had resolved. For this scenario, you can use the [usePrefetchQuery](https://tanstack.com/query/latest/docs/framework/react/guides/reference/usePrefetchQuery) or the [usePrefetchInfiniteQuery](https://tanstack.com/query/latest/docs/framework/react/guides/reference/usePrefetchInfiniteQuery) hooks available in the library.
...
Integration with other routers is also possible, see the [React Router example](https://tanstack.com/query/latest/docs/framework/react/examples/react-router) for another demonstration.
